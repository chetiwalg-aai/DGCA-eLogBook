...
(function () {
  ...
  const WSO_MAP = {
    'VIJP': {
      WSO: 'OAAIM20210000010242',
      ATS: 'OAAIM20210000010111',
      labelWSO: 'vijpwso',
      labelATS: 'VIJP_ATS',
    },
  };
  ...
  const TYPE_OF_DUTY_MAP = {
    ...
    [DUTY_TYPE.OJT_INSTR_PRACTICAL]: '2',
    [DUTY_TYPE.OJT_INSTR_THEORY]: '2',
    [DUTY_TYPE.OJT_TRAINING_PRACTICAL]: '3',
    [DUTY_TYPE.OJT_TRAINING_THEORY]: '5',
    [DUTY_TYPE.SKILL_ASSESSMENT]: '6',
    [DUTY_TYPE.EXAMINER_SKILL_TEST]: '4',
    [DUTY_TYPE.EXAMINER_PROF_CHECK]: '4',
    [DUTY_TYPE.EXAMINER_KNOWLEDGE]: '4',
  };
  const INSTRUCTOR_ATCOL_MAP = {
    'charan singh': '02647', 'shivram meena': '00706', 'mukesh chouhan': '00707',
    'sanjeev agrawal': '00660', 'sanjay kumar gupta': '00710', 'virendra kumar singhal': '00128',
    'vishweshar dayal meena': '01659', 'sugar singh meena': '01352', 'arvind kumar': '00711',
    'kunji lal meena': '01238', 'dharmendra kumar meena': '00712', 'vivek mahajan': '00713',
    'suresh kumar pareek': '00714', 'krishan mohan sharma': '02360', 'yogesh kumar jain': '00715',
    'rajesh kumar': '00716', 'shailndra singh asawat': '00668', 'sakil pal meena': '02547',
    'suruchi kaushik': '00717', 'sandeep kumar singh': '03175', 'tarun kumar': '02550',
    'tirupati choudhary': '01658', 'sumit mathur': '01383', 'anuradha sulaniya': '01654',
    'julie sandeep singh': '03547', 'mukesh kumar sharma': '00200', 'subhash chander bhardwaj': '01955',
    'deepak agrawal': '02356', 'raghunath singh': '00718', 'deepak kumar bageria': '01653',
    'amit srivastava': '00719', 'rajendra kumar': '00926', 'deepak kumar meena': '03902',
    'dinesh meena': '02355', 'ravi meena': '00303', 'rahul joshi': '03927', 'sanjay rakhecha': '01849',
    'hitesh bijoliya': '02793', 'amit kanjoliya': '01860', 'saroj meena': '01727', 'deshraj': '02022',
    'mahendra verma': '00671', 'atul kaswa': '01864', 'utkarsh agrawal': '01722', 'sumit kumar': '00685',
    'manoj singh pachera': '01790', 'komal singh': '01448', 'manjeet yadav': '02445',
    'meghana kumari parsanidya': '00692', 'arvind verma': '01291', 'pawan singh': '01564',
    'jai lakhiani': '01665', 'tripti gupta': '00727', 'om prakash sihag': '00729', 'ajay kumar meena': '01666',
    'praveen kumar jinjawadiya': '03062', 'jaid mohammad': '02695', 'bhupender': '03213',
    'ranu goyal': '03639', 'pradeep kumar': '03446', 'aditya bhatt': '03886', 'manvi gupta': '03882',
    'sakshi agarwal': '03919', 'prerna saini': '03918', 'aayush marmat': '03792', 'gaurav chetiwal': '03757',
    'bhawani shankar bunkar': '03917', 'rahul meena': '03938', 'satender': '01135', 'kartik lamba': '01217',
    'chetan sharma': '01191', 'alka dubey': '00413', 'deepak saini': '01976', 'devendra kumar patodiya': '00772',
  };
  ...
  function resolveAtsUnit(remarksText, stationCode) {
    ...
    // NEW: If the text is already a valid direct value (e.g., from EGcAexport), return it immediately!
    const allValues = Object.values(map);
    if (allValues.includes(r)) {
      return r;
    }
